        ...
        <div className='flex-1 '>
            <div className='flex items-center justify-between'>
                <div className='flex items-center space-x-1 whitespace-nowrap'>
                    <h4 className='font-bold text-xs trancate max-w-32'>
                        @{comment?.name}
                    </h4>
                    <span className='text-xs trancate max-w-32'>
                        @{comment?.username}
                    </span>
                    <span className='text-xl text-gray-500'>.</span>
                    <span className='text-xs text-gray-500 flex-1 trancate maax-w-32'>
