...
export const POST = async (req ) => {
    try {
        ...
        if(
            userWhoFollowsFromMongoDB._id.toString() === userProfileIdFromMongoDB._id.toString()
        ){
        return new Response('Who Can Follow yourself', { status: 400 });
        }
        ...
        return new Response(JSON.stringify(userWhoFollowsFromMongoDB), { status: 200, });
